...
<template>
  <div class="rewardBox commonBox">
    ...
    <section>
      <div class="">
        <img alt="" class="maxW" src="/static/img/timg.jpg">
      </div>
      <h1>@赞赏说明：</h1>
      <p>
      ...
      <el-row :gutter="30">
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
            <img :src="rewardData.wechat_image?rewardData.wechat_image:'/static/img/tou.jpg'"
        ...
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
            <img :src="rewardData.alipay_image?rewardData.alipay_image:'/static/img/tou.jpg'"
                 :onerror="$store.state.errorImg" alt="">
...
<style>
  ...
  .rewardBox section hr {
    background: #ccc;
    margin-bottom: 30px;
  }

  .rewardBox .donate-item {
    text-align: right;
    color: #44b549;

  }

  .rewardBox .donate-item:last-child {
    text-align: left;
    color: #00a0e9;
  }

  .rewardBox .donate-item img {
    width: 100%;
    display: block;
    height: auto;
  }

  .rewardBox .donate-item div {
  ...
  .rewardBox .donate-item div span {
    display: inline-block;
    width: 100%;
    margin: 10px 0;
    text-align: center;
  ...
  .rewardBox .el-table__body-wrapper {
    overflow: hidden;
  }
